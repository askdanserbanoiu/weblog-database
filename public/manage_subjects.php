...
require_once("controllers/manage_subjects_ctrl.php");  
?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Lista Categorie</h4>
                            </div>
		                                    ...
		                                    <tbody>
		                                      ...
		                                      ?>
		                                        <tr>
		                                           ...
		                                           <td><a href="edit_subject.php?subject=<?php echo $sub->subject; ?>"><i class="material-icons">edit</i></a>
		                                           <a onclick="return confirm('Sicuro di voler cancellare la categoria?');" href="control/delete_subject.php?subject=<?php echo $sub->subject; ?>"><i class="material-icons">cancel</i></a></td>
		                                         </tr>
		                                      <?php 
		                                      endforeach; 
		                                      ?>   
                            ...
                            <div class="content">
                                <h5 class="title">N.B. È possibile cancellare solo le categorie non riferite a nessun articolo</h5>
                            </div>
                        </div>
                    </div>
                </div>
