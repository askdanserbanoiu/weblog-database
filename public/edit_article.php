                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form  id="aggiungi_articolo" action="edit_article.php?article=<?php echo $_GET["article"]; ?>" method="POST" enctype="multipart/form-data">
                                <div class="content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="title" type="text" value="<?php echo $article->get_article_title(); ?>" readonly>
                                    </div>
                                    <!--   Scegli Immagine Cover   -->
                                    <div class="form-group">
                                        <div class="embed-responsive embed-responsive-16by9">
                                         <img class="embed-responsive-item" id="uploadPreview" src="images/<?php echo $article_pic->get_img_filename(); ?>"  />
                                        </div>
                                    ...
                                    <!--   Scegli Categorie   -->
                                     <div class="form-group">
                                        ...
                                        <?php 
                                            ...
                                            $subjects_article = Subject::find_all();
                                            foreach ($subjects as $subject) {
											    $sel = '';
											    if (in_array($subject, $subjects_article)) {
											        $sel = ' selected="selected" ';
											    }
											    echo '<option ' . $sel . ' value="' . $subject->subject . '">' . $subject->subject . '</option>';
											}  
                                        ?>
                                        </select>       
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="editor form-control" rows="5" name="body">
                                        	<?php echo $article->get_article_body(); ?>
                                        </textarea>
                                    </div>
                                    <button type="submit" name="submit" value="publish" class="btn btn-info btn-fill btn-wd">       Salva
                                    </button>
                                </div>
                            </form>
