...
require_once("controllers/new_subject_ctrl.php"); 
    ...
    <div class="sidebar" data-color="blue" data-image="assets/img/sidebar.jpg">
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="active"><a href="new_subject.php"><i class="pe-7s-box2"></i><p>Nuova Categoria</p></a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form  id="aggiungi_articolo" action="new_subject.php" method="POST">
                                <div class="content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="title" type="text" placeholder="Scegli Nome Categoria">
                                    </div>
                                    <!--   Scrivi Descrizione Categoria   -->
                                    <div class="form-group">
                                        <label class="control-label">Descrizione<span class="star"> *</span></label>
                                        <textarea class="form-control" rows="5" name="description" placeholder="Scrivi Descrizione Categoria">
                                        </textarea>
                                    </div>
                                    <button type="submit" name="submit" value="publish" class="btn btn-info btn-fill btn-wd">       Crea
                                    </button>
                                </div>
                            </form>
